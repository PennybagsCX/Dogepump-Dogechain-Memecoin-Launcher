...
export const NetworkStatus: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 pt-4 mt-6 border-t border-white/5 text-[10px] font-mono font-bold text-gray-500 uppercase tracking-wider md:flex-row md:flex-wrap md:items-center md:gap-6 md:border-t-0 md:border-l md:pl-6 md:ml-6 md:pt-0 md:mt-0 w-full md:w-auto">
      <div
